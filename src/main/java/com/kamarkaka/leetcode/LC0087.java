 ...
 *   "gr/eat" --> "g/r / e/at" // apply the same algorithm recursively on both substrings. divide at random index each
 *   of them.
...
public class LC0087 {
    public boolean isScramble(String s1, String s2) {
        ...
        if (s1.length() != s2.length()) return false; // pruning, length must be equal
