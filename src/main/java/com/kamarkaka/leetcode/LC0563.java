 ...
 * 0. The rule is similar if the node does not have a right child.
 * Example 1:
 *   Input: root = [1,2,3]
 *   Output: 1
 *   Explanation:
 ...
 *   Tilt of node 1 : |2-3| = 1 (left subtree is just left child, so sum is 2; right subtree is just right child, so sum
 *   is 3)
